...
<main id="main" role="main">
	<div id="shopify-section-template--15290673856674__main" class="shopify-section">
	   <article class="Article" data-section-id="template--15290673856674__main" data-section-type="article">
		  <div class="Article__ImageWrapper" style="background-image: url({{$blog_detail->image}})">
			 <div class="Article__Image Image--fadeIn Image--lazyLoaded" data-optimumx="1.4" data-bgset="{{$blog_detail->image}} 400w, {{$blog_detail->image}} 600w, {{$blog_detail->image}} 800w, {{$blog_detail->image}} 1200w, {{$blog_detail->image}} 1400w, {{$blog_detail->image}} 1600w" style="transform: translate3d(0px, 0px, 0px); background-image: url(&quot;{{$blog_detail->image}}&quot;);">
				<picture style="display: none;">
				   <source data-srcset="{{$blog_detail->image}} 400w, {{$blog_detail->image}} 600w, {{$blog_detail->image}} 800w, {{$blog_detail->image}} 1200w, {{$blog_detail->image}} 1400w, {{$blog_detail->image}} 1600w" sizes="1903px" srcset="{{$blog_detail->image}} 400w, {{$blog_detail->image}} 600w, {{$blog_detail->image}} 800w, {{$blog_detail->image}} 1200w, {{$blog_detail->image}} 1400w, {{$blog_detail->image}} 1600w">
		  ...
		  <div class="Article__Wrapper">
			 <div class="Article__Content">
				<header class="Article__Header">
				   <h1 class="Article__Title Heading u-h1">{{languageName($blog_detail->title)}}</h1>
				</header>
